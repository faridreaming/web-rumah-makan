...
<body class="bg-gray-100 p-2 h-svh flex flex-col gap-2">
  <header class="bg-green-500 rounded-md flex p-2 items-center justify-between">
    ...
    <a href="./logout.php" class="rounded h-full aspect-square flex items-center justify-center bg-green-200 p-2 hover:bg-white/75 transition duration-300 ease-in-out">
  ...
  <nav class="h-full">
    <ul class="bg-green-500 rounded-md w-fit px-2 py-4 font-medium text-sm flex flex-col gap-2 text-green-200 h-full [&>li>a>svg]:h-4 [&>li>a]:flex [&>li>a]:items-center [&>li>a]:gap-1 [&>li>a>svg]:text-green-300 [&>li>a>svg]:fill-current [&>li>a:hover_*]:text-white [&>li>a_*]:transition [&>li>a_*]:duration-300 [&>li>a_*]:ease-in-out">
      <li>
        <a href="">
          <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#FFFFFF">
