  ...
  <div
    ...
    <div
      ...
      <div
        ...
        <div
          class="absolute -bottom-full right-0 h-full w-full bg-gradient-to-b from-lime-500 to-green-500 transition-all group-target:bottom-0 sm:hidden sm:bg-gradient-to-r"></div>
        <div
          class="absolute -right-full bottom-0 hidden h-full w-full bg-gradient-to-b from-lime-500 to-green-500 transition-all group-target:right-0 sm:block sm:bg-gradient-to-r"></div>
        <div
      ...
      <div
        class="z-20 w-full translate-y-0 opacity-100 transition-[transform,opacity] duration-[500ms,500ms] group-target:z-0 group-target:translate-y-10 group-target:opacity-0 group-target:duration-[500ms,300ms] sm:translate-x-0 sm:group-target:translate-x-10 sm:group-target:translate-y-0">
    ...
    <div
      ...
      <div
        ...
        <div
          class="absolute left-0 top-0 h-full w-full bg-gradient-to-b from-lime-500 to-green-500 transition-all group-target:-top-full sm:hidden sm:bg-gradient-to-r"></div>
        <div
          class="absolute left-0 top-0 hidden h-full w-full bg-gradient-to-b from-lime-500 to-green-500 transition-all group-target:-left-full group-target:top-0 sm:block sm:bg-gradient-to-r"></div>
        <div
      ...
      <div
        class="-translate-y-10 opacity-0 transition-[transform,opacity] duration-[500ms,300ms] group-target:z-20 group-target:translate-y-0 group-target:opacity-100 group-target:duration-[500ms,500ms] sm:-translate-x-10 sm:translate-y-0 sm:group-target:translate-x-0 w-full">
